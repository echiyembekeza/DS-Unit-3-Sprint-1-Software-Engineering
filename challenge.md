...
Code review is vitally important in programming. This process can be viewed as akin to peer reviews in wet bench research...someone else has to be able to discern what you're doing with your code. In code reviews, there are two vital components to code review...make sure the code is "DRY" and not "WET". These things are essential. In code review, I would be looking to make sure that the coder doesn't repeat themselves. I would be looking to make sure that the code is readable...but even more than readability, the code should be reproducible.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
Containers are very important in situations where there are many different computers and operating systems. If any code that one produces is only able to work locally...that code is not going to be very functional. In order to make it scalable and usable, countainers would allow a programmer to package all of the required dependencies, in one place, in order to be deployed to different systems and smoothly run.
